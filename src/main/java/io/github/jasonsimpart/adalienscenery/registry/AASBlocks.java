...
import io.github.jasonsimpart.adalienscenery.block.BuddingLunarSapphireBlock;
...
public class AASBlocks {
    ...
    public static final RegistryObject<Block> BUDDING_LUNAR_SAPPHIRE_BLOCK = BLOCKS.register("budding_lunar_sapphire_block", () -> new BuddingLunarSapphireBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BLUE).randomTicks().strength(1.5F).sound(SoundType.AMETHYST).requiresCorrectToolForDrops().pushReaction(PushReaction.DESTROY)));
